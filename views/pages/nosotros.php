...
<head>
  ...
  <title>Nosotros TAPISUR | Historia familiar y marca</title>
  <meta name="description" content="Historia familiar de TAPISUR y trayectoria en tapiceria, restauracion y fabricacion a medida." />
...
<body class="page-shell page-nosotros">
  ...
  <header class="site-header" id="top">
    ...
    <div class="container nav-wrap">
      ...
      <a class="btn btn-primary nav-cta wa-link" data-wa-message="Hola TAPISUR, quiero conocer mas sobre la empresa." target="_blank" rel="noopener noreferrer" href="#">Hablar con TAPISUR</a>
    </div>
  </header>
    ...
    <section class="page-hero">
      <div class="container page-hero-grid">
        <div class="page-hero-copy reveal">
          ...
          <h1>Una segunda generacion que convierte oficio en marca</h1>
  ...
  <a class="whatsapp-float wa-link" data-wa-message="Hola TAPISUR, quiero conocer mas sobre la empresa." target="_blank" rel="noopener noreferrer" href="#" aria-label="Abrir WhatsApp">
  ...
  <footer class="site-footer">
    <div class="container footer-grid">
      <div>
        ...
        <p>Una marca familiar en crecimiento, basada en trayectoria real, oficio y atencion personalizada.</p>
      </div>
      <div>
        <h3>Navegacion</h3>
