...
<head>
  ...
  <title>Entregas TAPISUR | Agenda, zonas y fletes</title>
  <meta name="description" content="Informacion de entregas, fletes, cobertura y agenda de visitas de TAPISUR." />
...
<body class="page-shell page-entregas">
  ...
  <header class="site-header" id="top">
    ...
    <div class="container nav-wrap">
      ...
      <a class="btn btn-primary nav-cta wa-link" data-wa-message="Hola TAPISUR, quiero consultar por entregas y fletes." target="_blank" rel="noopener noreferrer" href="#">Consultar entrega</a>
    </div>
  </header>
  ...
  <a class="whatsapp-float wa-link" data-wa-message="Hola TAPISUR, quiero consultar por entregas y fletes." target="_blank" rel="noopener noreferrer" href="#" aria-label="Abrir WhatsApp">
  ...
  <footer class="site-footer">
    <div class="container footer-grid">
      <div>
        ...
        <p>Informacion clara sobre agenda, cobertura y coordinacion para acompanar todo el proceso comercial.</p>
      </div>
      <div>
        <h3>Navegacion</h3>
