...
$pageDescription = 'Canales de contacto de TAPISUR: WhatsApp, teléfonos, dirección y mapa.';
    ...
    <section class="page-hero">
      <div class="container page-hero-grid">
        <div class="page-hero-copy reveal">
          ...
          <p>Buscamos que cada consulta tenga una respuesta clara. Podés comunicarte para cotizaciones, servicios, entregas, alianzas o seguimiento.</p>
          <div class="hero-cta">
    ...
    <section class="section">
      <div class="container contact-grid">
        <div class="info-card reveal">
          ...
          <p>Atención por teléfono y WhatsApp, con respuesta permanente para acompañar consultas y coordinaciones.</p>
        </div>
